...
pub struct ElaborationOptions {
    ...
    #[clap(
        ...
        long,
        multiple = true,
        default_values = &["sko-rename", "polyeq", "hole", "eunif", "local", "uncrowd", "reordering"]
    )]
    ...
    fn into_config(self) -> Self::Output {
        ...
        let pipeline: Vec<_> = e
            ...
            .map(|p| match p {
                ...
                ElaborationPass::Eunif => elaborator::ElaborationPass::Eunif,
                ElaborationPass::SatRefutation => elaborator::ElaborationPass::SatRefutation,
                ElaborationPass::SkoRename => elaborator::ElaborationPass::SkoRename,
            })
            .collect();
