...
CVC5_BIN=/home/hbarbosa/cvc5/wt-diff/prod/bin/cvc5
CARCARA_BIN=/home/hbarbosa/carcara/wt-diff/target/release/carcara
...
CARCARA_OPTS=(
    ...
    --rare-file /home/hbarbosa/carcara/wt-diff/rewrites.eo
)
...
cvc5_rc=$?
if (( cvc5_rc != 0 )); then
    echo "warning: cvc5 exited with status $cvc5_rc; no proof generated" >&2
    printf '%s\n' "$raw" >&2
    exit "$cvc5_rc"
fi
