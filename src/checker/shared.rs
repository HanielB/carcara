...
pub fn get_rule(
    ...
    Some(match rule_name {
        ...
        "mult_neg" => linear_arithmetic::mult_neg,
        "mult_distrib" => linear_arithmetic::mult_distrib,
        ...
        "semilattice_simp" => simplification::semilattice_simp,
        "boolean_group_simp" => simplification::boolean_group_simp,
        "assoc_simp" => simplification::assoc_simp,
        ...
        "bv_repeat_elim" => bitvectors::repeat_elim,
        "absorb" => extras::absorb,

        // cvc5 emits the bitblasting rules under `bv_bitblast_step_*` names
        ...
        "bv_bitblast_step_bvshl" => bitvectors::shl,
        "bv_bitblast_step_bvlshr" => bitvectors::lshr,
        "bv_bitblast_step_bvashr" => bitvectors::ashr,
        "bv_bitblast_step_bvudiv" => bitvectors::udiv,
        "bv_bitblast_step_bvurem" => bitvectors::urem,
